...
//PASSO 5 - remover a classe ativo que marca o pokedev selecionado na listagem
   desativarPokedevNaListagem(cartaoPokedevAberto);
...
function desativarPokedevNaListagem(cartaoPokedevAberto) {
   const pokedevAtivoNaListagem = document.querySelector(".ativo");
   cartaoPokedevAberto.classList.remove("ativo");
}
